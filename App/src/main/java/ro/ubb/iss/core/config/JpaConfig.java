package ro.ubb.iss.core.config;
...
import ro.ubb.iss.core.service.AuthorService;
...
@Configuration
@EnableJpaRepositories({"ro.ubb.iss.core.repository"})
...
public class JpaConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factory.setPackagesToScan("ro.ubb.iss.core.model");
