...
class SessionControllerTest {
    ...
    void getAvailable() {
        for(int i=0; i<50; i++){
            this.ticketService.addTicket(new Ticket(i+20, new BigDecimal(100), i+20, new Date(System.currentTimeMillis()), "Vlad", 1));
        }
    ...
    void addSession() {
        ...
        assert this.sessionController.getAllSessions().getSessions().size() == 7;
        this.sessionService.deleteSession(this.sessionService.getAllSessions().get(6));
    }
}